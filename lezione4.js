...
//Creare un Array
//Il modo più comune per creare un array è utilizzare la sintassi letterale, racchiudendo gli elementi tra parentesi quadre [] e separandoli con virgole:

const numeri = [15, 63, 34, 43, 5];

const nomi = ["Mario", "Giulia", "Luca"];

//oppure con il metodo costruttore, meno comune ma comunque valido:
